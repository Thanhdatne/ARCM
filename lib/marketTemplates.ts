...
export const MARKET_TEMPLATES: MarketTemplate[] = [
  ...
  {
    id: "btc-above-120000-2026-07-31",
    title: "Will BTC close above $120,000 on July 31, 2026?",
    category: "Crypto",
    settlementRule:
      "YES if BTC/USD daily candle close is strictly above 120000 on Coinbase for July 31, 2026 UTC. Otherwise NO.",
    source: "Coinbase BTC/USD daily close",
    endDate: "2026-07-31",
    riskLevel: "Medium",
  },
  {
    id: "eth-above-4500-2026-07-31",
    title: "Will ETH close above $4,500 on July 31, 2026?",
    category: "Crypto",
    settlementRule:
      "YES if ETH/USD daily candle close is strictly above 4500 on Coinbase for July 31, 2026 UTC. Otherwise NO.",
    source: "Coinbase ETH/USD daily close",
    endDate: "2026-07-31",
    riskLevel: "Medium",
  },
  {
    id: "sol-above-250-2026-07-31",
    title: "Will SOL close above $250 on July 31, 2026?",
    category: "Crypto",
    settlementRule:
      "YES if SOL/USD daily candle close is strictly above 250 on Coinbase for July 31, 2026 UTC. Otherwise NO.",
    source: "Coinbase SOL/USD daily close",
    endDate: "2026-07-31",
    riskLevel: "Medium",
  },
  {
    id: "coin-above-450-2026-07-31",
    title: "Will Coinbase COIN close above $450 on July 31, 2026?",
    category: "Crypto",
    settlementRule:
      "YES if COIN official closing price is strictly above 450 USD on July 31, 2026. Otherwise NO.",
    source: "Nasdaq official COIN closing price",
    endDate: "2026-07-31",
    riskLevel: "Medium",
  },
  {
    id: "stablecoin-supply-above-300b-before-2026-09-01",
    title: "Will total stablecoin supply exceed $300B before September 1, 2026?",
    category: "Stablecoins",
    settlementRule:
      "YES if DefiLlama shows total stablecoin market cap equal to or above 300B USD on any day before September 1, 2026. Otherwise NO.",
    source: "DefiLlama Stablecoins",
    endDate: "2026-09-01",
    riskLevel: "Medium",
  },
  {
    id: "usdc-market-cap-above-75b-before-2026-09-01",
    title: "Will USDC market cap exceed $75B before September 1, 2026?",
    category: "Stablecoins",
    settlementRule:
      "YES if DefiLlama shows USDC market cap equal to or above 75B USD on any day before September 1, 2026. Otherwise NO.",
  ...
  {
    id: "nvda-above-200-2026-07-31",
    title: "Will NVDA close above $200 on July 31, 2026?",
    category: "AI",
    settlementRule:
      "YES if NVDA official closing price is strictly above 200 USD on July 31, 2026. Otherwise NO.",
  ...
  {
    id: "gold-above-3000-2026-07-31",
    title: "Will gold close above $3,000 on July 31, 2026?",
    category: "Macro",
    settlementRule:
      "YES if gold official close/settlement is strictly above 3000 USD on July 31, 2026. Otherwise NO.",
    source: "COMEX gold futures official settlement or selected gold spot reference",
    endDate: "2026-07-31",
    riskLevel: "Medium",
  },
  {
    id: "tokenized-us-treasury-aum-above-10b-before-2026-09-01",
    title: "Will tokenized US Treasury AUM exceed $10B before September 1, 2026?",
    category: "RWA",
    settlementRule:
      "YES if tokenized US Treasury AUM is equal to or above 10B USD on the selected source before September 1, 2026. Otherwise NO.",
    source: "RWA.xyz or DefiLlama RWA dashboard",
    endDate: "2026-09-01",
    riskLevel: "Medium",
  },
  {
    id: "blackrock-buidl-aum-above-3b-before-2026-09-01",
    title: "Will BlackRock BUIDL AUM exceed $3B before September 1, 2026?",
    category: "RWA",
    settlementRule:
      "YES if BlackRock BUIDL AUM is equal to or above 3B USD before September 1, 2026. Otherwise NO.",
