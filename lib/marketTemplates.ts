...
export const MARKET_TEMPLATES: MarketTemplate[] = [
  ...
  {
    id: "btc-above-120000-2026-12-31",
    title: "Will BTC close above $120,000 on December 31, 2026?",
    category: "Crypto",
    settlementRule:
      "YES if BTC/USD daily candle close is strictly above 120000 on Coinbase for December 31, 2026 UTC. Otherwise NO.",
    source: "Coinbase BTC/USD daily close",
    endDate: "2026-12-31",
    riskLevel: "Medium",
  },
  {
    id: "eth-above-4000-2026-12-31",
    title: "Will ETH close above $4,000 on December 31, 2026?",
    category: "Crypto",
    settlementRule:
      "YES if ETH/USD daily candle close is strictly above 4000 on Coinbase for December 31, 2026 UTC. Otherwise NO.",
    source: "Coinbase ETH/USD daily close",
    endDate: "2026-12-31",
    riskLevel: "Medium",
  },
  {
    id: "sol-above-200-2026-12-31",
    title: "Will SOL close above $200 on December 31, 2026?",
    category: "Crypto",
    settlementRule:
      "YES if SOL/USD daily candle close is strictly above 200 on Coinbase for December 31, 2026 UTC. Otherwise NO.",
    source: "Coinbase SOL/USD daily close",
    endDate: "2026-12-31",
    riskLevel: "Medium",
  },
  {
    id: "coin-above-250-2026-12-31",
    title: "Will Coinbase COIN close above $250 on December 31, 2026?",
    category: "Crypto",
    settlementRule:
      "YES if COIN official closing price is strictly above 250 USD on December 31, 2026. Otherwise NO.",
